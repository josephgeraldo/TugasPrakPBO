...
public class StatusPembelian {
    ...
    public StatusPembelian(){
        ...
        for (int i = 0; i < listPesanan.size(); i++) {
            ...
            if(listPesanan.get(i).getStatusPengiriman() == statusPengiriman.PENGEMASAN){
                panelList1.add(panel, gbc, 0);
            }else if(listPesanan.get(i).getStatusPengiriman() == statusPengiriman.MENCARI_KURIR){
                panelList2.add(panel, gbc, 0);
            }else if(listPesanan.get(i).getStatusPengiriman() == statusPengiriman.DALAM_PERJALANAN){
